...
3. **Steps 2-7:** RED → GREEN loop for each test scenario
4. **Commit:** ONE atomic commit with tests + implementation + mocks
...
- RED phase must FAIL before implementing
- GREEN phase must PASS before committing
...
**Atomic Commit Rules:**
- Individually shippable (complete, deployable)
- Safely revertible
